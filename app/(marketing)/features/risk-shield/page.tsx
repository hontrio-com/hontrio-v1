...
const en = {
  ...
  heroSignal4: 'COD (cash on delivery) order 890 RON',
  ...
  painSub: 'Every returned COD (cash on delivery) parcel costs far more than just the product value. It accumulates into a real monthly loss.',
  ...
  step1: 'A customer places a COD (cash on delivery) order in your store. Risk Shield is triggered automatically, no manual action needed.',
  ...
  sigCat2Items: ['Order value', 'Number of products', 'COD (cash on delivery) vs prepayment ratio', 'Category risk'],
  ...
  faqs: [
    { q: 'Does Risk Shield work with all couriers?', a: 'Yes. Risk Shield analyzes order data independently of which courier you use. It integrates with your online store and reads order and customer data directly, regardless of the shipping provider.' },
...
const ro = {
  ...
  heroSignal4: 'Comanda COD (plata la livrare) 890 RON',
  ...
  painSub: 'Fiecare colet refuzat COD (plata la livrare) costa mult mai mult decat valoarea produsului. Se acumuleaza intr-o pierdere reala lunara.',
  ...
  sigCat2Items: ['Valoarea comenzii', 'Numar de produse', 'Raport COD (plata la livrare) vs plata in avans', 'Risc categorie'],
  ...
  faqs: [
    { q: 'Risk Shield functioneaza cu toti curierii?', a: 'Da. Risk Shield analizeaza datele comenzilor independent de curierul folosit. Se integreaza cu magazinul tau online si citeste datele comenzilor si ale clientilor direct, indiferent de furnizorul de curierat.' },
...
const profilesEn = {
  ...
  problematic: {
    ...
    flags: [
      ...
      { text: 'COD (cash on delivery) order 890 RON', color: '#ca8a04', bg: 'rgba(202,138,4,0.08)' },
...
const profilesRo = {
  ...
  problematic: {
    ...
    flags: [
      ...
      { text: 'Comanda COD (plata la livrare) 890 RON', color: '#ca8a04', bg: 'rgba(202,138,4,0.08)' },
