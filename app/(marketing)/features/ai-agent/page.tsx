...
const en = {
  ...
  step2: 'Download the Hontrio module directly from your dashboard and install it in your WooCommerce store in a few clicks, just like any other plugin.',
  ...
  faqs: [
    ...
    { q: 'How long does it take until the agent knows my entire catalog?', a: 'The initial sync takes between a few seconds and a few minutes, depending on the number of products. After that, any new product added in WooCommerce appears automatically in the agent knowledge.' },
  ],
...
const ro = {
  ...
  step2: 'Descarci modulul Hontrio direct din dashboard si il instalezi in magazinul WooCommerce in cateva click-uri, la fel ca orice alt plugin.',
